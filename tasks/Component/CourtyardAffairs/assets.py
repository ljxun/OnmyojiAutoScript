...
class CourtyardAffairsAssets: 
	...
	# Image Rule Assets
	# 进入庭院事务按钮 
	I_COURTYARD_AFFAIRS_BUTTON = RuleImage(roi_front=(1189,299,35,33), roi_back=(1168,127,76,389), threshold=0.8, method="Template matching", path="./res/courtyard_affairs_button.png", file="./tasks/Component/CourtyardAffairs/res/courtyard_affairs_button.png")
	# 庭院事务主页面 
	I_COURTYARD_AFFAIRS_PAGE = RuleImage(roi_front=(277,41,160,51), roi_back=(277,41,160,51), threshold=0.8, method="Template matching", path="./res/courtyard_affairs_page.png", file="./tasks/Component/CourtyardAffairs/res/courtyard_affairs_page.png")
	# 一键完成 
