...
class RestartAssets: 
	...
	# 一键领取 
	I_HARVEST_MAIL_ALL = RuleImage(roi_front=(78,597,48,39), roi_back=(16,543,166,147), threshold=0.8, method="Template matching", file="./tasks/Restart/harvest/harvest_harvest_mail_all.png")
	# 有些邮件需要点击一次 
	...
	# 邮箱页面标头 
	I_HARVEST_MAIL_TITLE = RuleImage(roi_front=(520,48,245,41), roi_back=(517,36,284,81), threshold=0.8, method="Template matching", file="./tasks/Restart/harvest/harvest_harvest_mail_title.png")
	# 体力 
