...
class GameUiAssets: 
	...
	# 红色❌ 
	I_BACK_RED = RuleImage(roi_front=(1041,111,34,38), roi_back=(834,15,427,200), threshold=0.8, method="Template matching", file="./tasks/GameUi/common/back_red.png")
	# 刷新 
	...
	# description 
	I_CHECK_SOUL_ZONES1 = RuleImage(roi_front=(117,29,68,29), roi_back=(102,3,176,88), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_check_soul_zones1.png")
	# description 
	...
	# 秘闻副本 
	I_CHECK_SECRET_ZONES = RuleImage(roi_front=(163,30,124,35), roi_back=(99,16,203,63), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_check_secret_zones.png")
	# description 
	...
	# 町进入百鬼_2 
	I_TOWN_GOTO_HYAKKIYAKOU_2 = RuleImage(roi_front=(714,139,16,63), roi_back=(657,111,123,123), threshold=0.7, method="Template matching", file="./tasks/GameUi/page/page_town_goto_hyakkiyakou_2.png")
	# description 
	...
	# description 
	I_MAIN_GOTO_FRIENDS = RuleImage(roi_front=(879,623,55,55), roi_back=(33,591,1153,100), threshold=0.7, method="Template matching", file="./tasks/GameUi/page/page_main_goto_friends.png")
	# 进入花合战 
	I_MAIN_GOTO_DAILY = RuleImage(roi_front=(779,612,51,67), roi_back=(33,591,1153,100), threshold=0.7, method="Template matching", file="./tasks/GameUi/page/page_main_goto_daily.png")
	# description 
	I_MAIN_GOTO_MALL = RuleImage(roi_front=(663,661,41,22), roi_back=(33,591,1153,100), threshold=0.7, method="Template matching", file="./tasks/GameUi/page/page_main_goto_mall.png")
	# description 
	I_MAIN_GOTO_GUILD = RuleImage(roi_front=(540,611,50,54), roi_back=(33,591,1153,100), threshold=0.7, method="Template matching", file="./tasks/GameUi/page/page_main_goto_guild.png")
	# description 
	...
	# 结界界面 
	I_CHECK_REALM_SHIN = RuleImage(roi_front=(175,460,54,58), roi_back=(22,380,393,308), threshold=0.9, method="Template matching", file="./tasks/GameUi/page/page_realm_shin.png")
	# 寮种树升级提示 
