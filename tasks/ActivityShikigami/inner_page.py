...
page_climb_act.link(button=G.I_BACK_YELLOW, destination=page_main)
# 爬塔活动副界面
...
page_climb_act_pass.link(button=G.I_BACK_YELLOW, destination=page_climb_act_2)
...
page_climb_act_ap.additional = [asa.O_ENTRY_ACTIVITY, asa.I_SKIP_BUTTON, asa.I_TOGGLE_BUTTON, gga.I_UI_REWARD,
                                asa.I_RED_EXIT]
page_climb_act_ap.link(button=G.I_BACK_YELLOW, destination=page_climb_act_2)
