...
class RichManAssets: 
	...
	# 密卷屋 
	I_MALL_SCCALES = RuleImage(roi_front=(470,649,68,49), roi_back=(427,621,147,92), threshold=0.7, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_mall_sccales.png")
	# 密卷屋 
	I_MALL_SCCALES_CHECK = RuleImage(roi_front=(412,231,100,100), roi_back=(327,150,266,271), threshold=0.8, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_mall_sccales_check.png")
	# description 
	...
	# 杂货铺 
	I_MALL_SUNDRY_CHECK = RuleImage(roi_front=(392,7,869,46), roi_back=(392,7,869,46), threshold=0.7, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_mall_sundry_check.png")
	...
	# 荣誉商店标志 
	I_SIDE_CHECK_HONOR = RuleImage(roi_front=(392,7,869,46), roi_back=(392,7,869,46), threshold=0.7, method="Template matching", file="./tasks/RichMan/mall/navbar/navbar_side_check_honor.png")
	# 友情点 
