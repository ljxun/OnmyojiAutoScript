...
class DokanAssets: 
	...
	# 管理放弃道馆over 
	I_QUIT_DOKAN_OVER = RuleImage(roi_front=(1056,211,55,28), roi_back=(1056,211,55,28), threshold=0.8, method="Template matching", file="./tasks/Dokan/res/Screenshots_quit_dokan_over.png")
	# 寮友同意放弃突破 
